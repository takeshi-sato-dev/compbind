...
def plot_free_energy_with_errors(stats: Dict, config):
    ...
    # Error bars
    region_1_errors = [[stats['region_1_free_energy'][p] - stats['region_1_ci_low'][p] for p in pairs],
                       [stats['region_1_ci_high'][p] - stats['region_1_free_energy'][p] for p in pairs]]
    region_2_errors = [[stats['region_2_free_energy'][p] - stats['region_2_ci_low'][p] for p in pairs],
                       [stats['region_2_ci_high'][p] - stats['region_2_free_energy'][p] for p in pairs]]
    diff_errors = [[stats['free_energy_difference'][p] - stats['diff_ci_low'][p] for p in pairs],
                   [stats['diff_ci_high'][p] - stats['free_energy_difference'][p] for p in pairs]]
